...
# WEB SCRAPPING # WEB SCRAPPING# WEB SCRAPPING# WEB SCRAPPING # WEB SCRAPPING # WEB SCRAPPING
...
usd33 = str(usd)[133:141]
euro33 = str(euro)[160:167]
def data_entry():
    c.execute("INSERT INTO currency (USD, EURO) VALUES(?, ?)", (usd33, euro33))
    conn.commit()
...
class page(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.lbl1= QtWidgets.QLabel('<b> 1 $ : '+ str(usd)[133:140] +" DZD"+'</b>',self)
        self.lbl1.setStyleSheet('color: white; font-size:12px; font-family:tajwal;')
        self.lbl1.move(110,250)

        self.lbl2= QtWidgets.QLabel('<b> 1 € : '+ str(euro)[160:167] +" DZD"+'</b>',self)
        ...
        usd1= str(usd)[133:140]
        euro1= str(euro)[160:167]
        ...
        self.lbl3.move(80,210)


        self.fieldEdit = QLineEdit("  Enter your value",self)
        self.fieldEdit.move(80,180)
...
# END OF SOFTWARE # END OF SOFTWARE # END OF SOFTWARE # END OF SOFTWARE # END OF SOFTWARE
